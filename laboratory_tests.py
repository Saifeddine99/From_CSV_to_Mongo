...
def save_laboratory_test_results(analyses_dict):
    ...
    for test_name,test_result in analyses_dict.items():
        ...
        laboratory_test_results_list[-1]["content"][0]["data"]["events"][0]["data"]["items"][6]["items"][2]["value"]["magnitude"]=test_result
        laboratory_test_results_list[-1]["content"][0]["data"]["events"][0]["data"]["items"][0]["value"]["value"]=test_name.upper()
